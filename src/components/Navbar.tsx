...
import { Phone, ArrowUpRight, Menu, X, Sparkles, MessageSquare } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <nav className="hidden lg:flex items-center gap-8 font-mono text-xs font-semibold text-slate-300">
            <a href="#prozess" className="hover:text-emerald-400 transition-colors">01. Ablauf</a>
            <a href="#projekte" className="hover:text-emerald-400 transition-colors">02. Showcase</a>
            <a href="#ki-telefonie" className="hover:text-emerald-400 transition-colors">03. KI-Voice</a>
            <a href="#leistungen" className="hover:text-emerald-400 transition-colors">04. Pakete</a>
            <a href="#kalkulator" className="hover:text-emerald-400 transition-colors">05. Kalkulator</a>
            <a href="#faq" className="hover:text-emerald-400 transition-colors">06. FAQ</a>
          </nav>
