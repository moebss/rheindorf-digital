...
export default function RoiCalculator({ onOpenContact }: RoiCalculatorProps) {
  ...
  return (
    <section id="rechner" className="py-24 sm:py-32 bg-[#030712] border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          <div className="luxury-pill border-rose-500/30 text-rose-400 bg-rose-500/10 mb-4">
        ...
        {/* Calculator Luxury Card */}
        <div className="max-w-5xl mx-auto luxury-card p-8 sm:p-12 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-xl sm:text-2xl font-black text-white bg-[#030712] px-4 py-1.5 rounded-2xl border border-white/10">
              ...
              <input
                ...
                className="w-full h-2 bg-[#0D1527] rounded-lg appearance-none cursor-pointer accent-emerald-400"
              />
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-xl sm:text-2xl font-black text-emerald-400 bg-[#030712] px-4 py-1.5 rounded-2xl border border-white/10">
            ...
            <div className="p-5 bg-[#030712] rounded-2xl border border-white/10 text-xs font-mono text-slate-300 space-y-2">
          ...
          {/* Result Card (5 Cols) */}
          <div className="lg:col-span-5 bg-[#0D1527] border border-rose-500/30 p-8 rounded-3xl text-center space-y-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="bg-[#030712] p-4 rounded-2xl border border-white/10 space-y-1">
